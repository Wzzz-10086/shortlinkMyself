...
import com.wzzz.shortlink.project.mq.consumer.ShortLinkStatsSaveConsumer;
...
import static com.wzzz.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_STATS_STREAM_GROUP_KEY;
import static com.wzzz.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_STATS_STREAM_TOPIC_KEY;


//TODO 需要了解redis stream的消息队列使用
/**
 * Redis Stream 消息队列配置
 */
@Configuration
